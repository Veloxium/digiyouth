        ...
        <section>
            <div class="mt-10 md:mt-20 place-content-start place-items-center gap-4  mx-auto px-4 sm:px-6 lg:px-20">
                ...
                <div class="flex justify-center items-center gap-4 mt-10">
                    <button class="flex items-center gap-2 py-2 px-4 rounded-md transition-colors" style="transition: background-color 0.2s, color 0.2s; cursor: pointer;" onmouseover="this.style.backgroundColor='#a02a2d';this.style.color='#fff';" onmouseout="this.style.backgroundColor='';this.style.color='';">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-10 gap-y-8 gap-x-4 my-20 w-full">
                    ...
                    <div class="card" style="flex: 0 0 auto;">
                        <div class="relative overflow-hidden  h-[200px] md:h-[270px] w-full md:w-[424px] bg-zprimary rounded-2xl place-content-center place-items-center p-6 mb-4">
                ...
                <div class="mb-20">
                    <nav class="flex items-center justify-center mt-8 space-x-2">
                        <a href="#" class="w-10 h-10 flex justify-center items-center bg-white rounded-md pag text-gray-500 hover:bg-zprimary hover:text-white transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="inline w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                            </svg>
                        </a>
                        <a href="#" class="w-10 h-10 flex justify-center items-center bg-white rounded-md pag bg-zprimary text-white">1</a>
                        <a href="#" class="w-10 h-10 flex justify-center items-center bg-white rounded-md pag text-gray-700 hover:bg-zprimary hover:text-white transition-colors">2</a>
                        <a href="#" class="w-10 h-10 flex justify-center items-center bg-white rounded-md pag text-gray-700 hover:bg-zprimary hover:text-white transition-colors">3</a>
                        <span class="w-10 h-10 flex justify-center items-center bg-white text-gray-400 rounded-md">...</span>
                        <a href="#" class="w-10 h-10 flex justify-center items-center bg-white rounded-md pag text-gray-700 hover:bg-zprimary hover:text-white transition-colors">10</a>
                        <a href="#" class="w-10 h-10 flex justify-center items-center bg-white rounded-md pag text-gray-500 hover:bg-zprimary hover:text-white transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="inline w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
