...
@section('content')
    ...
    <div class="font-outfit">
        <section>
            <div
                class="grid grid-cols-1 md:grid-cols-2 mt-10 md:mt-0 place-content-start place-items-center gap-4 max-w-7xl mx-auto px-4 sm:px-6 lg:px-20">
                <div class="text-left">
                    ...
                    <p class="text-lg mb-8 max-w-lg">
                        Tunjukkan inovasimu di DigiYouth Showcase dan buat dunia melihat potensimu. Jangan lewatkan momen
                        ini, kirimkan karyamu sekarang, dan jadilah pelopor di era digital!
                    </p>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-20 lg:py-10 flex flex-col items-center justify-center mt-20">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
                    <a href="{{ url('/category/hacker?sort=latest') }}"
                        class="px-4 py-6 w-[350px] border border-zprimary rounded-2xl flex gap-2 items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-shield-lock">
                    ...
                    <a href="{{ url('/category/hustler?sort=latest') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-graph">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    ...
                    <a href="{{ url('/category/cloud-engineer?sort=latest') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-cloud">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path
                    ...
                    <a href="{{ url('/category/graphic-designer?sort=latest') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-palette">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path
            ...
            <div x-data="{
                ...
                <div class="flex items-center justify-between w-full mb-10">
                    ...
                    <div class="flex gap-4">
                        <button class="w-16 h-16 rounded bg-white place-content-center place-items-center"
                            @click="scrollByCardLeft" type="button">
                        ...
                        <button class="w-16 h-16 rounded bg-white place-content-center place-items-center"
                            @click="scrollByCard" type="button">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <!-- Row -->
                <div class="flex gap-8 overflow-x-scroll w-full h-full scrollbar-hide" x-ref="cardsRow"
                    style="scroll-behavior: smooth;">
                    @foreach ($popularProjects as $project)
                        <div class="card" style="flex: 0 0 auto;">
                            <div
                                class="relative overflow-hidden h-[415px] w-[700px] bg-zprimary rounded-2xl place-content-center place-items-center p-6 mb-8">
            ...
            <div x-data="{
                ...
                <div class="relative w-full mt-6 flex items-center justify-between">
                    <div class="absolute flex justify-between items-center w-full">
                        <button class="md:-ml-10 w-16 h-16 rounded bg-white place-content-center place-items-center"
                            @click="scrollByCardLeft" type="button">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <button class="md:-mr-10 w-16 h-16 rounded bg-white place-content-center place-items-center"
                            @click="scrollByCard" type="button">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="flex gap-8 md:gap-12 overflow-x-scroll w-full h-full scrollbar-hide" x-ref="cardsRow"
                        style="scroll-behavior: smooth;">
                        @foreach ($topContributors as $user)
                            <div class="cardProfile group" style="flex: 0 0 auto;">
                                <div
                                    class="h-[315px] w-[340px] border border-gray-200 shadow-md transition ease-in-out duration-500 group-hover:bg-[#a02a2d] rounded-2xl place-content-center place-items-center p-6 mb-8">
                                    <img src="{{ $user->profile_picture ? asset('storage/public/user/profile/' . $user->profile_picture) : asset('images/profile.png') }}"
                                        class="w-32 h-32 rounded-full bg-gray-500 transition ease-in-out duration-500 group-hover:bg-white" />

                                    <p
                                        class="font-semibold my-4 transition ease-in-out duration-500 group-hover:text-white">
                                        {{ $user->name }}</p>
                                    <p class="transition ease-in-out duration-500 group-hover:text-white">
                                        {{ $user->class }}</p>
                                </div>
                            </div>
                        @endforeach
